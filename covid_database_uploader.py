...
# This script is for creating a database and storing all data from the Covid Tracking Project
# into it. This is now only used for creating databases to run tests on them./

# Connect to Database

# conn = sqlite3.connect('new_temp.db')
